...
export const ru: TranslationMap = {
	...
	"editor.commandsNotFound": "Команды не найдены",
	"editor.heading2": "Заголовок 2",
	"editor.heading3": "Заголовок 3",
	"editor.heading4": "Заголовок 4",
	"editor.blockType": "Тип блока",
	"editor.paragraph": "Текст",
	"editor.placeholder": "Начните с мысли, идеи или наблюдения…",
	...
	"account.delete.description": "Все материалы и настройки будут удалены без возможности восстановления.",
	"account.delete.action": "Удалить аккаунт",
	"account.delete.confirmTitle": "Удалить аккаунт?",
	"account.delete.confirmDescription": "Это действие нельзя отменить.",
